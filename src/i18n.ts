...
const pt: TranslationMap = {
  ...
  'dashboard.teamsDescription': 'Use Google para criar workspaces e manter salas fixas por time.',
...
const en: TranslationMap = {
  ...
  'dashboard.teamsDescription': 'Use Google to create workspaces and keep fixed rooms per team.',
...
const fr: TranslationMap = {
  ...
  'dashboard.teamsDescription': 'Utilisez Google pour creer des espaces de travail et garder des salles fixes par equipe.',
